...
& gap under BPR delay, offered load $>4\times$ & 80.5\% \\
& gap in delivered rate, same rows & 29.8\% \\
& \quad bottleneck loss instead of compounding & 37.0\% \\
& \quad max-min fair sharing & 37.3\% \\
\midrule
...
& learned / blind, training shell & 0.976 / 0.668 \\
...
& learned / blind, unseen 264 & 0.908 / 0.973 \\
\midrule
...
& GNN / blind multipath, 132 sat (trained) & 0.980 / 0.660 \\
& GNN / blind multipath, 198 sat & 0.915 / 0.968 \\
& GNN / blind multipath, 264 sat & 0.898 / 0.970 \\
& GNN / blind multipath, 396 sat & 0.933 / 0.960 \\
& GNN / blind multipath, 264 sat at $70^\circ$ & 0.932 / 0.944 \\
\midrule
\multicolumn{3}{@{}l}{\emph{Does diverse training restore it? (same instance budget)}}\\
& single-shell training, unseen 264 & 0.929 \\
& mixed training, unseen 264 & 0.978 \\
\midrule
\multicolumn{3}{@{}l}{\emph{Does proactivity reach an axis blind multipath cannot?}}\\
& proactive / blind multipath, trained shell & 0.962 / 0.801 \\
& proactive / blind multipath, unseen shell & 0.736 / 0.984 \\
\bottomrule
\end{tabular}
\end{table}
