...
marked-up copy, \textcolor[rgb]{0,0,0.75}{blue} text is new in this resubmission and
\textcolor[rgb]{0.7,0,0}{red} text was present in the previous submission and has been removed;
unmarked text is unchanged. The same legend appears at the head of the marked-up copy itself. We
have used colour alone rather than underlining or strikethrough so that the marked pages read at
the same size and weight as the final paper.
