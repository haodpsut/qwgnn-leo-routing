...
\textbf{Overlap disclosure.} One of our manuscripts under review elsewhere, at IEEE Transactions on
Vehicular Technology, studies when coordination helps multi-user handover in LEO constellations. It
shares the constellation simulator with this work and nothing else: it takes handover events as
given and studies policy, whereas this paper studies the evaluation of routing under load. There
are no shared results, tables or figures.
